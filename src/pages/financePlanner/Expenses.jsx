      ...
      <div className="p-2">
        ...
        >
          <div className={`p-3 rounded-full bg-gradient-to-r ${theme.primary}`}>
            <ReceiptCentIcon className={`w-8 h-8 ${theme.text}`} />
          </div>
          <div>
            <h1 className={`md:text-3xl font-bold ${theme.highlight}`}>Expense Tracker</h1>
            <p className="md:text-lg">Track and manage your daily expenses</p>
          </div>
        </motion.div>
